      ...
      <div className="flex items-center gap-2 mb-3 min-w-0">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {onApprove && (
            <button
              onClick={onApprove}
              className={`inline-flex items-center justify-center gap-1.5 h-8 w-8 sm:w-auto sm:px-2.5 rounded-lg border transition-colors focus:outline-none focus:ring-2 focus:ring-green-400/50 active:scale-[0.97] text-xs font-medium ${
                isApproved

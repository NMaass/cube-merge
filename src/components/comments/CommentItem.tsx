        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          {onSetResolution && (
            <button
              ...
              className="ml-auto text-xs text-slate-500 hover:text-slate-300 transition-colors shrink-0 focus:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 rounded"
